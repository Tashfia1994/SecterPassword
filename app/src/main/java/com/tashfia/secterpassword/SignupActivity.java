...
public class SignupActivity extends AppCompatActivity {
    ...
    EditText etxtName,etxtCell,etxtPassword,etxtemail;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etxtCell=(EditText)findViewById(R.id.etxt_email);
        etxtPassword=(EditText)findViewById(R.id.etxt_password);
        etxtemail=(EditText)findViewById(R.id.etxt_pass);
    ...
    private void sign_up() {
        ...
        final String email = etxtCell.getText().toString().trim();
